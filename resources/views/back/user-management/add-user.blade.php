    ...
    <div
        ...
        <form action="{{ route('user.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 uppercase">Name <span
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 uppercase">Email <span
                            class="text-red-700">*</span></label>
                ...
                <div class="mb-4 relative">
                    ...
                    <i id="togglePassword"
                        class="fa-solid fa-eye-slash mt-3 absolute right-3 top-1/2 -translate-y-1/2 
                                text-gray-500 cursor-pointer transition-colors duration-200">
                    </i>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        const passwordInput = document.getElementById('password-user-add');
